    ...
    <section className="min-h-screen flex items-center relative overflow-hidden pt-20">
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        <div className="max-w-[720px]">
          ...
          {/* Title */}
          <h1 className="opacity-0 animate-fade-up-delay-2 font-display text-[clamp(3.5rem,10vw,7.5rem)] leading-[1.05] md:leading-[0.92] tracking-tight mb-6 text-shadow-gold">
